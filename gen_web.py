...
def list_models(platform: str = "runware") -> dict:
    ...
    if platform == "modelslab":
        ...
        web_models = ["flux-dev", "flux-uncensored", "pony-xl", "pony-real", "prefect-ill-xl", "guofeng4-xl", "pornmaster", "lustify", "sdxl-vanilla", "dreamshaper-xl", "juggernaut-xl", "fantasy-reality-xl", "zimage-alibaba", "zimage-moody", "qwen-edit", "dreamshaper-15", "majicmix-real-15", "realcartoon3d-15", "aniverse-15", "chikmix-15", "realcartoon-real-15", "perfect-world-15", "majicmix-lux-15", "dark-sushi-25d-15", "guofeng-wuxia-15", "tastyrice-cg-15", "onlyrealistic-15", "chilloutmix-15", "chosen-mix-15", "abyss-orange-mix-15", "nwsj-real-mix-sdxl"]
