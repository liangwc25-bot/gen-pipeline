...
def list_loras(model: str = None) -> dict:
    ...
    model_aliases = {"pony-xl": "pony", "prefect-ill-xl": "illustrious", "flux-uncensored": "flux-dev", "guofeng4-xl": "sdxl", "pornmaster": "sdxl", "lustify": "sdxl", "sdxl-vanilla": "sdxl", "dreamshaper-xl": "sdxl", "juggernaut-xl": "sdxl", "fantasy-reality-xl": "sdxl"}
...
def list_models(platform: str = "runware") -> dict:
    ...
    if platform == "modelslab":
        ...
        web_models = ["flux-dev", "pony-xl", "prefect-ill-xl", "guofeng4-xl", "pornmaster", "lustify", "sdxl-vanilla", "dreamshaper-xl", "juggernaut-xl", "fantasy-reality-xl", "qwen-edit", "flux-uncensored"]
