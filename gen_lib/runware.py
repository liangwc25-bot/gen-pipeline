...
MODELS = {
    ...
    "zimage-turbo":   {"id": "runware:twinflow-z-image-turbo@0", "name": "TwinFlow Z-Image-Turbo", "price": "$0.0006/张"},
...
def generate(prompt: str, *, model_key: str = "flux-dev",
    ...
    task = {
        ...
        "height": h,
        "steps": steps,
        "CFGScale": cfg_scale if cfg_scale is not None else (6.0 if model_key in ("pony-xl", "pony-real", "prefect-ill-xl", "guofeng4-xl", "pornmaster", "sdxl-vanilla", "dreamshaper-xl", "juggernaut-xl", "lustify", "fantasy-reality-xl") else 3.5),
