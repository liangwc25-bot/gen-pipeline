...
MODELS = {
    ...
    "sdxl-base":      {"id": "civitai:101055@126613", "name": "SD XL Base", "price": "~$0.003/张"},
...
def generate(prompt: str, *, model_key: str = "flux-dev",
    ...
    task = {
        ...
        "height": h,
        "steps": 28,
        "CFGScale": cfg_scale if cfg_scale is not None else (6.0 if model_key in ("pony-xl", "prefect-ill-xl", "guofeng4-xl", "pornmaster", "sdxl-base", "dreamshaper-xl", "juggernaut-xl") else 3.5),
